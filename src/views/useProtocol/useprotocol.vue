<template>
  <div class="useProtocol">
        <h3 class="title">Apex Wallet Service Agreement</h3>
...
Apex Wallet reserves the right, at our sole discretion, to change, modify, add or remove the terms of this Agreement based on actual needs, at any time. Once the revised agreement is announced, it will be legally binding on you. If you do not accept the modified agreement, you have the right to stop using Apex Wallet, but your continued use of Apex Wallet will mean that you accept and agree to the modified agreement.</p>
        <h3>1、Definition </h3>
        <p>Apex Wallet: Apex Wallet is our Explorer that supports CPX, NEO, GAS and other types of assets, as well as smart contracts.
        </p>
        <p>2. Users:
        ...
        <p>（2）Your Use of Apex Wallet
            ...
            <p>8. Service Charge and Tax Obligation:
            <p>
            （1）Apex Wallet will not charge you any service fee or handling fee for the time being. If certain services are to be charged in the future, the latest announcement shall prevail;
            </p>
            <p>
            （2）When you use Apex Wallet for money transfer, you should pay the handling fee to the miner who accounts for it and the amount paid is to be decided by you. Handling fee is collected by the relevant blockchain system and will be distributed to the miners who are billed;
            </p>
            <p>
            （3）Due to the unstable environment and network status, the blockchain system will still charge the fees of the miners when the transfer fails.
            </p>
            <p>
            ...
            <p>
            4. During the transaction, you should decide on your own whether the other party is a person with full civil capacity and whether or not to trade with or transfer to the other party, and all related risks shall be borne by you.</p>
            <p>
            5. During the transfer process, if a “transaction failure” notification or any similar message pops up, you should reconfirm it through official route of the relevant blockchain system or other blockchain enquiry tools to avoid duplicate transfers; otherwise, all loss and expenses caused shall be borne by you.
            </p>
            <p>
            6. You acknowledge that when you create or import a wallet on Apex Wallet, your Keystore, Private Key, and mnemonic are only stored in the current mobile device but not in Apex Wallet or our servers. You can replace your mobile device with the way of importing wallet, etc, following the instructions provided by Apex Wallet. However, if you do not save or back up your wallet password, Private Key, mnemonic, Keystore, and if you lose your mobile device, we will not be able to recover your lost digital tokens and the loss caused will be borne by you. If you leak the password when exporting, saving or backing up your wallet password, Private Key, mnemonic, Keystore, or if the device or server that saves or backs up the above information is hacked or controlled by others, we will not be able to recover your lost digital tokens and the loss caused will be borne by you.
            </p>
            <p>
            7. We recommend that you make a secure backup of your wallet password and Keystore information when creating or importing your wallet. You should pay attention not to use the following backup methods: screenshots, email, notepad, SMS, WeChat, QQ and other electronic backup methods. We recommend that you copy information such as Keystore on a paper notebook, and you may also keep your electronic data in a password manager.
            </p>
            <p>
            8. We recommend that you use Apex Wallet in a secure network environment to avoid potential security risks.
            </p>
            <p>
            ...
            <p>
            <p>
            1. You agree that we may temporarily stop providing or suspend some service functions, or cease to open new service functions in the future to ensure autonomy of our business operation. When there is a reduction or an increase in the service functions provided, your continued use of our service would mean that you still agree to the terms or any modified terms of this Agreement.
            </p>
            <p>
            2. You understand that we will suspend the provision of services when:
            ...
            <p>
            <p>
            1. You shall abide by the relevant laws and regulations of China and the laws and regulations of the country or region in which you live. You may not use Apex Wallet for any illegal purposes or use our services in any illegal way.
            </p>
            <p>
            ...
            <p>
            In order to fulfill your needs of using Apex Wallet service, we collect the following information and we value the protection of your privacy. When we collect your information, we will strictly comply with the principle of “legality, legitimacy, necessity”. If you do not provide the required information we need, your service experience at Apex Wallet may be affected consequently.
            </p>
            <p>
            1. We will collect your personal information such as your mobile device information, operation history, transaction history, and wallet address.
            </p>
            <p>
            2. In order to meet your specific service needs, we will collect your name, bank card number, mobile phone number, email address and other information.
            </p>
            <p>
            3. Other personal information collected based on the needs of our specific products and services, including but not limited to your opinions and suggestions about Chinapex Technology and our products or services.
            </p>
            <p>
            ...
            <p>
            1. We confirm your correspondence to your wallet with a unique serial number for your mobile device.
            </p>
            <p>
            2. We will promptly send you important notices such as software updates, service agreements and changes to the terms of this Agreement.
            </p>
            <p>
            3. We process the feedback you submit to Chinapex Technology by collecting your public wallet address and mobile device information provided.
            </p>
            <p>
            4. We collect your personal information for our internal audit, data analysis and research, in order to continuously improve our service standard.
            </p>
            <p>
            5. In accordance with this Agreement and our other relevant regulations, we will use your information to manage and handle your use of our service.
            </p>
            <p>
            ...
            <p>
            1. If we stop operation, we will stop collecting your personal information promptly, place the notice of termination of service on Apex Wallet, and will delete or anonymize your personal information held within a reasonable period.
            </p>
            <p>
            2. In order to protect your personal information, we will adopt data security technology measures and enhance the level of internal compliance, and increase the internal employee information security training, and set the relevant data security methods such as information security to protect your privacy.
            </p>
            <p>
            ...
            <p>
            <p>We make the following special agreement for the protection of minors under the age of 18:
           ...
           8. You understand that Apex Wallet is only a tool for managing digital tokens and displaying trading information, we do not provide legal, tax or investment advice. You should seek advice from professionals in the legal, tax, and investment fields, and we are not responsible for any investment loss, data loss that you suffer from using our services.
            ...
            <p>
            1. This Agreement, the amendments of this Agreement and the rules we publish from time to time form the entire agreement between you and Chinapex Technology.
            </p>
            <p>
            2. If any provision of this Agreement is held to be invalid or illegal in any respect by a competent court, the validity and legality of the remaining provisions contained herein shall not be affected thereby.
            </p>
            ...
            <p>
           1. The laws of the People's Republic of China shall govern the legal effect, interpretation, modification, implementation and dispute resolution of this Agreement and its amendments. If there is no applicable legal provision, practice of international business and/or industry shall apply.
            </p>
            <p>
            2.  When a dispute arises, the parties shall make every endeavor to resolve it through amicable consultation or mediation. If such consultation or mediation comes to no avail, either party may submit the dispute to the People’s Court in the place of our legal domicile.
            </p>
            
            <h3>13、 Miscellaneous</h3>
            <p>
            1.  If you are a user outside of China, you need to fully understand and comply with all relevant laws, rules and regulations in your jurisdiction related to the use of our service.
            </p>
            <p>
            2.  If you encounter any problems while using our services, you can contact Chinapex Technology by submitting feedback on Apex Wallet.
            </p>
            <p>
            3.  You can view this Agreement in Apex Wallet. We recommend that you review our service agreement each time you visit Apex Wallet.
            </p>
            <p>
            4.  In the event of a conflict between the Chinese version and the English version, the Chinese version shall prevail.
            </p>
            <p>With respect to matters not covered in this Agreement, you are subject to announcements and related rules we update from time to time.
